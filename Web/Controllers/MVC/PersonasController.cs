...
namespace Web.Controllers.MVC
{
    public class PersonasController : Controller
    {
        ...
        {
            var ejemplo94Context = _context.Persona.Include(p => p.IdGeneroNavigation);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdPersona,Identificacion,Nombre,Apellido,Direccion,Email,Telefono,Celular,Estado,IdGenero")] Persona persona)
        {
